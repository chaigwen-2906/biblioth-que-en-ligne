    ...
    <div class="contenuFooter">
        ...
        <div class="mentionFooter">
            <div>
                ...
                <div><img class="iconMentions" alt="Mentions Légales" title="Mentions Légales"  src="app/public/image/icon/puce.png"><a href="./front-mentionsLegales"><span>Mentions Légales</span></a></div>
                <div><img class="iconMentions" alt="Conditions Générales" title="Conditions Générales"  src="app/public/image/icon/puce.png"><a href="./front-conditionsGenerales"><span>Conditions générales</span></a></div>
                <div><img class="iconMentions" alt="Règlement général sur la protection des données" title="Règlement général sur la protection des données"  src="app/public/image/icon/puce.png"><a href="./front-rgpd"><span>RGPD</span></a></div>
                <div><img class="iconMentions" alt="Plan du site" title="Plan du site" src="app/public/image/icon/puce.png"><a href="./front-planDuSite"><span>Plan du site</span></a></div>
            </div>
        </div>
