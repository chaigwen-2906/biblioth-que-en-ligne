...
<html lang="fr">
    ...
    <head>
        ...
        <title> Supprimer une foire aux questions - Ma bibliothèque en ligne</title>
    ...
    <body>
        <main class="supprimerLivre">
            ...
            <form method="POST" action="./<?= $this->nomPage;?>?action2=supprimerFAQ&idFaq=<?= $idFaq;?>">

                <h2>
                    Voulez vous réellement supprimer une FAQ !  
                </h2>
