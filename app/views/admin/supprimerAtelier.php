...
<html lang="fr">
    ...
    <head>
        ...
        <title> Supprimer atelier - Ma bibliothèque en ligne</title>
    ...
    <body>
        <main class="supprimerLivre">
            ...
            <form method="POST" action="./<?= $this->nomPage;?>?action2=supprimerAtelier&idAtelier=<?= $idAtelier;?>">

                <h2>
                    Voulez vous réellement supprimer l'atelier !  
                </h2>
