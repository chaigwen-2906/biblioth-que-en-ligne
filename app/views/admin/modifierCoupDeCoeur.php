...
<html lang="fr">
    ...
    <head>
        ...
        <title> Modifier les coup de coeur - Ma bibliothèque en ligne</title>
    ...
    <body>
        <main class="ajoutLivre">
            ...
            <form method="POST" action="./<?= $this->nomPage;?>?action2=modifierCoupDeCoeur&idCoupDeCoeur=<?= $idCoupDeCoeur;?>">
